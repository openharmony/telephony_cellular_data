...
public:
    ...
    MOCK_METHOD2(HasOperatorPrivileges, int32_t(const int32_t, bool &));
    ...
    MOCK_METHOD2(SetSimLabelIndex, int32_t(int32_t, int32_t));
    MOCK_METHOD2(SetSimLabelIndexByIccId, int32_t(const std::string &, int32_t));
    ...
    MOCK_METHOD1(SwapM0M2SimCards, int32_t(int32_t));
    ...
    MOCK_METHOD1(SetSpecifiedIccidBySlotId, void(int32_t, std::string &));
};
}  // namespace Telephony
}  // namespace OHOS

...
#ifndef MOCK_CORE_SERVICE_H
#define MOCK_CORE_SERVICE_H
...
class MockCoreService : public ICoreService {
public:
    MockCoreService() = default;
    ~MockCoreService() = default;
    ...
    MOCK_METHOD(int32_t, GetLockState, (int32_t slotId, LockType lockType, LockState &lockState), (override));
    ...
    MOCK_METHOD(int32_t, IsCTSimCard, (int32_t slotId, bool &isCTSimCard), (override));
    MOCK_METHOD(bool, IsSimActive, (int32_t slotId), (override));
    MOCK_METHOD(int32_t, GetSlotId, (int32_t simId), (override));
    MOCK_METHOD(int32_t, GetSimId, (int32_t slotId), (override));
    MOCK_METHOD(int32_t, GetNetworkSearchInformation, (int32_t slotId, const sptr<INetworkSearchCallback> &callback),
        (override));
    MOCK_METHOD(
    ...
    MOCK_METHOD(std::u16string, GetSimEons,
        (int32_t slotId, const std::string &plmn, int32_t lac, bool longNameRequired), (override));
    MOCK_METHOD(int32_t, SetNetworkSelectionMode,
    ...
    MOCK_METHOD(int32_t, QueryIccDiallingNumbers,
        (int slotId, int type, std::vector<std::shared_ptr<DiallingNumbersInfo>> &result), (override));
    MOCK_METHOD(int32_t, AddIccDiallingNumbers,
        (int slotId, int type, const std::shared_ptr<DiallingNumbersInfo> &diallingNumber), (override));
    MOCK_METHOD(int32_t, DelIccDiallingNumbers,
        (int slotId, int type, const std::shared_ptr<DiallingNumbersInfo> &diallingNumber), (override));
    MOCK_METHOD(int32_t, UpdateIccDiallingNumbers,
        (int slotId, int type, const std::shared_ptr<DiallingNumbersInfo> &diallingNumber), (override));
    MOCK_METHOD(int32_t, SetVoiceMailInfo,
    ...
    MOCK_METHOD(int32_t, SimAuthentication,
        ...
        (override));
    MOCK_METHOD(int32_t, RegisterImsRegInfoCallback,

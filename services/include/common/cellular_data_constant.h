...
static const std::string CALL_STATE_CHANGE_ACTION = "com.hos.action.CALL_STATE_CHANGE";
...
static const std::string CONFIG_MULTIPLE_CONNECTIONS = "persist.sys.data.multiple.connections";
...
static const std::string DEFAULT_MULTIPLE_CONNECTIONS = "0";

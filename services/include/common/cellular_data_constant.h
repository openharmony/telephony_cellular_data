...
static constexpr const char *CELLULAR_DATA_RDB_URI = "dataability:///com.ohos.pdpprofileability";
static constexpr const char *CELLULAR_DATA_RDB_SELECTION = "dataability:///com.ohos.pdpprofileability/net/pdp_profile";

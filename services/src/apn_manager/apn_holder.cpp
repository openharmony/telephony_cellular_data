...
const std::map<std::string, int32_t> ApnHolder::apnTypeDataProfileMap_ {
    ...
    {DATA_CONTEXT_ROLE_SNSSAI1, DATA_PROFILE_SNSSAI1},
    {DATA_CONTEXT_ROLE_SNSSAI2, DATA_PROFILE_SNSSAI2},
    {DATA_CONTEXT_ROLE_SNSSAI3, DATA_PROFILE_SNSSAI3},
    {DATA_CONTEXT_ROLE_SNSSAI4, DATA_PROFILE_SNSSAI4},
    {DATA_CONTEXT_ROLE_SNSSAI5, DATA_PROFILE_SNSSAI5},
    {DATA_CONTEXT_ROLE_SNSSAI6, DATA_PROFILE_SNSSAI6},
};
...
void ApnHolder::RequestCellularData(const NetRequest &netRequest)
{
    ...
    TELEPHONY_LOGI("RequestCellularData, capability[%{public}" PRIu64 "]", capability_);
}

void ApnHolder::ReleaseAllCellularData()
{
    dataCallEnabled_ = false;
    TELEPHONY_LOGI("ReleaseAllCellularData, capability[%{public}" PRIu64 "]", capability_);
}

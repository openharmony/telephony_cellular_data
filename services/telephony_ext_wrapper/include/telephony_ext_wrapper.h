...
public:
    ...
    typedef bool (*IS_DISTRIBUTED_CELLULAR_ALLOWED_FOR_SLOT)(int32_t);
    ...
    IS_DISTRIBUTED_CELLULAR_ALLOWED_FOR_SLOT isDistributedCellularAllowedForSlot_ = nullptr;
...
private:
    ...
    void InitIsDistributedCellularAllowedForSlot();
